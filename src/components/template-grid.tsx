export function TemplateGrid() {
  ...
  return (
    <section className="relative bg-[#f5f5f7] pt-24 pb-32 text-center rounded-t-[3rem] shadow-[0_-20px_50px_rgba(0,0,0,0.3)] z-20 mt-[-4rem]">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
          {templates.map((t, i) => (
            <div 
              key={i}
              className={`relative overflow-hidden rounded-3xl p-6 ${t.color} text-white shadow-xl flex items-center justify-between gap-6 transition-transform hover:-translate-y-2 hover:shadow-2xl`}
              style={{ width: i % 2 === 0 ? '45%' : '50%', minWidth: '300px', height: '220px', marginTop: i % 2 !== 0 ? '40px' : '0' }}
            >
              {/* Inner floating cards mimicking the image-to-3d effect */}
