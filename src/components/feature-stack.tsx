...
function Mockup({ kind, accent }: { kind: MockupKind; accent: string }) {
  if (kind === "ideation") {
    return (
      <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden bg-zinc-950/70 border border-white/5 p-5 backdrop-blur-md">
  ...
  if (kind === "writing") {
    return (
      <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden border border-white/5 backdrop-blur-md bg-[#0e0d18]">
  ...
  if (kind === "editing") {
    return (
      <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden border border-white/5 backdrop-blur-md bg-black/40 p-5">
  ...
  if (kind === "cover") {
    return (
      <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden border border-white/5 backdrop-blur-md bg-black/30 p-5">
        <div className="flex items-center justify-between mb-4">
  ...
  if (kind === "checkout") {
    return (
      <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden border border-white/5 backdrop-blur-md bg-gradient-to-br from-slate-900 via-zinc-900 to-black p-5 flex gap-5">
