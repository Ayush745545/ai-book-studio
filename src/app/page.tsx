...
export default async function LandingPage() {
  // Degrade gracefully when DATABASE_URL is missing/placeholder/unreachable —
  // show a setup banner instead of a runtime error screen.
  let dbError: string | null = null;
  let trendingBooks: BookWithAuthor[] = [];
  try {
    trendingBooks = await prisma.book.findMany({
  ...
  return (
    <div className="overflow-hidden">
      ...
      {trendingBooks.length > 0 && (
        <section className="section-reveal relative mx-auto max-w-7xl px-5 sm:px-8 py-20 md:py-24 border-b border-white/5 overflow-hidden">
          ...
          <div className="reveal-stagger relative grid gap-6 lg:grid-cols-12 lg:gap-8 items-stretch">
